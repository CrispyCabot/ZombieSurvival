...
def gameOverScreenLoad():
    global gameOverBtns
    gameOverBtns = []
    playBtn = Button((screenWidth - 300)/2,(screenHeight-100)/2+30,300,100,[200,20,20], 'Play Again', plFont, [0,0,0], plFont2)
    gameOverBtns.append(playBtn)
    quitBtn = Button((screenWidth-300)/2, (screenHeight-50)/2+110,300,50, [20,20,20], 'Quit', splFont, [150,150,150], splFont2)
...
def loadZombies():
    ...
    global z1AttackL
    z1AttackL = []
    img = pygame.image.load(path+os.path.join('zombie1','animation','Attack1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Attack2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    zombieWidth, zombieHeight = img.get_rect().size
    img = pygame.transform.flip(img, True, False)
    z1AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Attack3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Attack4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Attack5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Attack6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1AttackL.append(img)
    ...
    global z1DeathL
    z1DeathL = []
    img = pygame.image.load(path+os.path.join('zombie1','animation','Dead1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Dead2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Dead3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Dead4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Dead5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Dead6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Dead7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Dead8.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1DeathL.append(img)
    ...
    global z1HurtL
    z1HurtL = []
    img = pygame.image.load(path+os.path.join('zombie1','animation','Hurt1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Hurt2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Hurt3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Hurt4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Hurt5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1HurtL.append(img)
    ...
    global z1IdleL
    z1IdleL = []
    img = pygame.image.load(path+os.path.join('zombie1','animation','Idle1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Idle2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Idle3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Idle4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1IdleL.append(img)
    ...
    global z1JumpL
    z1JumpL = []
    img = pygame.image.load(path+os.path.join('zombie1','animation','Jump1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Jump2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Jump3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Jump4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Jump5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Jump6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Jump7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1JumpL.append(img)
    ...
    global z1RunL
    z1RunL = []
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run8.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run9.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Run10.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1RunL.append(img)
    ...
    global z1WalkL
    z1WalkL = []
    img = pygame.image.load(path+os.path.join('zombie1','animation','Walk1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Walk2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Walk3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Walk4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Walk5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie1','animation','Walk6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z1WalkL.append(img)
    ...
    global z2AttackL
    z2AttackL = []
    img = pygame.image.load(path+os.path.join('zombie2','animation','Attack1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Attack2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Attack3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Attack4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Attack5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Attack6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2AttackL.append(img)
    ...
    global z2DeathL
    z2DeathL = []
    img = pygame.image.load(path+os.path.join('zombie2','animation','Dead1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Dead2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Dead3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Dead4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Dead5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Dead6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Dead7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Dead8.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2DeathL.append(img)
    ...
    global z2HurtL
    z2HurtL = []
    img = pygame.image.load(path+os.path.join('zombie2','animation','Hurt1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Hurt2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Hurt3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Hurt4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Hurt5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2HurtL.append(img)
    ...
    global z2IdleL
    z2IdleL = []
    img = pygame.image.load(path+os.path.join('zombie2','animation','Idle1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Idle2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Idle3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Idle4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2IdleL.append(img)
    ...
    global z2JumpL
    z2JumpL = []
    img = pygame.image.load(path+os.path.join('zombie2','animation','Jump1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Jump2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Jump3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Jump4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Jump5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Jump6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Jump7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2JumpL.append(img)
    ...
    global z2RunL
    z2RunL = []
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run8.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run9.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Run10.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2RunL.append(img)
    ...
    global z2WalkL
    z2WalkL = []
    img = pygame.image.load(path+os.path.join('zombie2','animation','Walk1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Walk2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Walk3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Walk4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Walk5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie2','animation','Walk6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z2WalkL.append(img)
    ...
    global z3AttackL
    z3AttackL = []
    img = pygame.image.load(path+os.path.join('zombie3','animation','Attack1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Attack2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Attack3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Attack4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Attack5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3AttackL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Attack6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3AttackL.append(img)
    ...
    global z3DeathL
    z3DeathL = []
    img = pygame.image.load(path+os.path.join('zombie3','animation','Dead1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Dead2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Dead3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Dead4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Dead5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Dead6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Dead7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3DeathL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Dead8.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3DeathL.append(img)
    ...
    global z3HurtL
    z3HurtL = []
    img = pygame.image.load(path+os.path.join('zombie3','animation','Hurt1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Hurt2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Hurt3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Hurt4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3HurtL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Hurt5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3HurtL.append(img)
    ...
    global z3IdleL
    z3IdleL = []
    img = pygame.image.load(path+os.path.join('zombie3','animation','Idle1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Idle2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Idle3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3IdleL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Idle4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3IdleL.append(img)
    ...
    global z3JumpL
    z3JumpL = []
    img = pygame.image.load(path+os.path.join('zombie3','animation','Jump1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Jump2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Jump3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Jump4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Jump5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Jump6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3JumpL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Jump7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3JumpL.append(img)
    ...
    global z3RunL
    z3RunL = []
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run7.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run8.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run9.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Run10.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3RunL.append(img)
    ...
    global z3WalkL
    z3WalkL = []
    img = pygame.image.load(path+os.path.join('zombie3','animation','Walk1.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Walk2.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Walk3.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Walk4.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Walk5.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3WalkL.append(img)
    img = pygame.image.load(path+os.path.join('zombie3','animation','Walk6.png'))
    imgW, imgH = img.get_rect().size
    img = pygame.transform.scale(img, (int(scaler*imgW), int(scaler*imgH)))
    img = pygame.transform.flip(img, True, False)
    z3WalkL.append(img)
...
def drawPlayStuff():
    ...
    if playing:
        ...
        win.blit(timeText, (screenWidth-10-w,screenHeight-10-h))
    else:
